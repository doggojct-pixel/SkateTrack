...
Shared/Models/SessionData.swift                         # Updates diagnostics build identity to Task-030c-b14-B-1.
...
iOS/Features/Debug/DebugToolsPanelView.swift             # Shows the Task-030c-b14-B-1 Debug build signature.
...
Task-030c-b14-B-1 verification token: DeadReckoningReadinessAnalyzer, DeadReckoningReadinessConfig, replay-only gap eligibility, blockingReasonCounts, verify_task030c_b14a_dead_reckoning_readiness.py.
...
Task-030c-b14-B-1 verification token: altitude chart source guard, barometer-relative altitude profile, no stored sample rewrite, no route geometry change.

### Task-030c-b14-B-1 altitude micro-dip display guard
...
Task-030c-b14-B-1 verification token: altitude micro-dip display guard, barometer-relative chart profile, no stored sample rewrite, no route geometry change.
...
Task-030c-b14-B-1 verification token: startup route visual suppression, solid fluorescent-pink route context, no stored sample rewrite, no route geometry change.
...
Task-030c-b14-B-1 verification token: DeadReckoningCandidateInterpolationAnalyzer, debugCandidateOnly, anchorClosureTooLarge, no stored sample rewrite, no route geometry change.
...
Task-030c-b14-B-1 verification token: summary elevation gain source guard, trusted barometer-relative climb, no stored sample rewrite, no route geometry change.
