#!/usr/bin/env python3
"""Verify Task-030c-b15-A total elevation gain terminology stays localization-only."""
...
def main() -> int:
    checks = [
        ...
        ("docs/adr/ADR-INDEX.md", "Task-030c-b15-A — Total Elevation Gain Terminology"),
        ("docs/history/DEV_LOG.md", "Task-030c-b15-A — Total Elevation Gain Terminology"),
        ("docs/release/KNOWN_LIMITATIONS_PRE_ADP.md", "Task-030c-b15-A — Total Elevation Gain Terminology"),
        ("docs/reference/FILE_STRUCTURE.md", "Task-030c-b15-A total elevation gain terminology"),
    ]
    ...
    print("Task-030c-b15-A total elevation gain terminology checks passed.")
    return 0
...
if __name__ == "__main__":
    try:
        ...
        print(f"Task-030c-b15-A total elevation gain terminology check failed: {exc}", file=sys.stderr)
        raise SystemExit(1)
