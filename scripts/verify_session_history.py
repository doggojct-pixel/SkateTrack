...
REQUIRED_FILES = [
    ...
    "iOS/Features/SessionHistory/SessionHistoryBulkActionBarView.swift",
...
LOCALIZATION_KEYS = [
    ...
    "history.selection.cancel",
    "history.selection.mode.subtitle",
    "history.selection.subtitle",
    "history.selection.countFormat",
    "history.selection.selectAll",
    "history.selection.clear",
    "history.selection.delete",
    "history.delete.confirm.title",
    "history.delete.confirm.buttonFormat",
    "history.delete.confirm.messageFormat",
    "history.delete.error.title",
    "history.delete.error.generic",
...
PROJECT_TOKENS = [
    ...
    "SessionHistoryBulkActionBarView.swift in Sources",
...
SOURCE_TOKENS = {
    "iOS/Hooks/useSessionHistory.swift": [
        ...
        "visibleSessionIDs(isSubscriber:",
        "deleteSessions(ids:",
    ...
    "docs/reference/FILE_STRUCTURE.md": [
        ...
        "Task-017b History Navigation + Summary Handoff",
        "SessionHistory/",
        "SessionHistoryBulkActionBarView.swift",
...
MAX_LINES = {
    "iOS/Features/SessionHistory/SessionHistoryView.swift": 460,
    "iOS/Features/SessionHistory/SessionHistoryListView.swift": 280,
    "iOS/Features/SessionHistory/SessionHistoryCardView.swift": 260,
    ...
    "iOS/Features/SessionHistory/SessionHistoryBulkActionBarView.swift": 180,
