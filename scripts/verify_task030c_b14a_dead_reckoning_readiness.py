#!/usr/bin/env python3
"""Verify Task-030c-b14-B-1 replay-only dead-reckoning readiness diagnostics."""
...
def main() -> int:
    ...
    if failures:
        print("Task-030c-b14-B-1 replay-only dead-reckoning readiness check failed:", file=sys.stderr)
        for failure in failures:
            print(f"  {failure}", file=sys.stderr)
        return 1
    print("Task-030c-b14-B-1 replay-only dead-reckoning readiness checks passed.")
    return 0
