...
REQUIRED_FILES=["macOS/Features/SessionBrowser/MacSessionBrowserView.swift","macOS/Features/SessionBrowser/MacSessionDetailView.swift","macOS/Features/SessionBrowser/MacSessionViewerModel.swift","macOS/Features/SessionBrowser/MacSpeedSparklineView.swift","macOS/Features/SessionBrowser/MacRoutePreviewView.swift","macOS/Features/SessionBrowser/MacRouteMapContextView.swift","scripts/verify_macos_route_chart_viewer.py","docs/adr/ADR-INDEX.md"]
...
def ensure_project_membership():
    ...
    for t in ["MacRoutePreviewView.swift","MacRouteMapContextView.swift","MacSpeedSparklineView.swift","MacSessionViewerModel.swift"]:
    ...
    for t in ["MacRoutePreviewView.swift in Sources","MacRouteMapContextView.swift in Sources","MacSpeedSparklineView.swift in Sources"]:
...
def ensure_route_foundation():
    ...
    for t in ["MacRoutePoint","MacRouteVisualizationQuality","routePoints","uniqueRoutePointCount","routeQuality(","distanceMetersBetween","downsample(routePoints:"]:
...
def ensure_boundaries():
    ...
    for p in ["macOS/Features/SessionBrowser/MacSessionBrowserView.swift","macOS/Features/SessionBrowser/MacSessionDetailView.swift","macOS/Features/SessionBrowser/MacSessionViewerModel.swift","macOS/Features/SessionBrowser/MacSpeedSparklineView.swift","macOS/Features/SessionBrowser/MacRoutePreviewView.swift","macOS/Features/SessionBrowser/MacRouteMapContextView.swift"]:
        txt=read(p)
