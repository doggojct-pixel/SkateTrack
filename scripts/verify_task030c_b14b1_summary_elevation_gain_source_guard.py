#!/usr/bin/env python3
"""Verify Task-030c-b15-A Summary elevation-gain source guard remains display-only."""
...
def main() -> int:
    checks = [
        ("Shared/Models/SessionData.swift", 'static let currentDebugBuildTaskID = "Task-030c-b15-A"'),
        ("iOS/Features/Debug/DebugToolsPanelView.swift", 'Text("Task-030c-b15-A")'),
        ("iOS/Hooks/useSessionSummary.swift", "Task-030c-b15-A: Summary climb must use the same trusted altitude-source"),
        ...
        ("scripts/verify_task030c_b14b1_summary_elevation_gain_source_guard.py", "Task-030c-b15-A Summary elevation-gain source guard"),
        ("docs/adr/ADR-INDEX.md", "Task-030c-b15-A — Summary Elevation Gain Source Guard"),
        ("docs/history/DEV_LOG.md", "Task-030c-b15-A — Summary Elevation Gain Source Guard"),
        ("docs/release/KNOWN_LIMITATIONS_PRE_ADP.md", "Task-030c-b15-A — Summary Elevation Gain Source Guard"),
        ("docs/reference/FILE_STRUCTURE.md", "Task-030c-b15-A summary elevation gain source guard"),
    ]
    ...
    print("Task-030c-b15-A summary elevation gain source guard checks passed.")
    return 0
...
if __name__ == "__main__":
    try:
        ...
        print(f"Task-030c-b15-A summary elevation gain source guard check failed: {exc}", file=sys.stderr)
        raise SystemExit(1)
